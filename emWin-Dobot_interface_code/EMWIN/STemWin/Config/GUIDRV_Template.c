...
{
	LCD_Fast_DrawPoint(x,y,PixelIndex); //调用ILI93xx.c文件中的快速打点函数						/************************修改后**************************/
}
...
static unsigned int _GetPixelIndex(GUI_DEVICE * pDevice, int x, int y) {
    ...
    GUI_USE_PARA(y);
    {
			PixelIndex = LCD_ReadPoint(x,y);																						/************************修改后**************************/
    }
...
{
	LCD_Fill(x0,y0,x1,y1,LCD_COLORINDEX);																						/************************修改后**************************/
}
